...
const NoSupportedAgentsDetectedMessage = "No supported agents detected. Install Claude Code, Codex CLI, or Gemini CLI, or rerun with --agent claude, --agent codex, --agent gemini, or --agent all."
