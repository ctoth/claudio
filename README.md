...
events from Claude Code, OpenAI Codex CLI, and Gemini CLI, maps the event to a
contextual sound, and plays that sound without making the agent wait for
playback.
